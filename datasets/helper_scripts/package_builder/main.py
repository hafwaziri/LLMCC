        ...
        with sqlite3.connect('../../debian_source_test.db') as conn_local:
            ...
            cursor_local.execute("""
                INSERT OR REPLACE INTO packages (
                    ...
                    rebuild_stderr, rebuild_returncode, modified_rebuild_stderr, modified_rebuild_returncode, test_stdout_for_modified_package,
                    test_stderr_for_modified_package, test_passed
                ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
            """, (package_name, build_system, dh_auto_config, dh_auto_build, dh_auto_test,
                ...
                test_stdout_for_modified_package, test_stderr_for_modified_package, test_passed))
            conn_local.commit()
...
def main():
    ...
    CREATE TABLE IF NOT EXISTS packages (
        ...
        test_stdout_for_modified_package TEXT,
        test_stderr_for_modified_package TEXT,
        test_passed INTEGER
    )
    ''')
